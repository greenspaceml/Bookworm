...
<html>
    <%
        ...
        Photo Uphoto = photoDAO.getPhotoByUserID(user.getID());
    %>
    <head>
        ...
        <div id="colorlib-page">
            ...
            <aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        <li class="colorlib-active"><a href="aboutMe?uid=<%=user.getID()%>">About Me</a></li>
                        <li><a href="myPosts?uid=<%=user.getID()%>">My Posts</a></li>
                            <%
                ...
                <div class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url(images/<%=Uphoto.getPhotoname()%>);" data-stellar-background-ratio="0.5">
                    ...
                    <div class="js-fullheight d-flex justify-content-center align-items-center">
                        <div class="col-md-8 text text-center">
                            <div class="img mb-4" style="background-image: url(images/<%=Uphoto.getPhotoname()%>);"></div>
                            <div class="desc">
                                <h2 class="subheading">Hello I'm</h2>
                                <h1 class="mb-4"><%=user.getDisplayname()%></h1>
                                <p class="mb-4"><%=Uphoto.getTittle()%></p>
                                <p class="mb-4"> Hobbies : <%=user.getHobbies()%></p>
                                <p class="mb-4"> Date of birth :<%=user.getDateOfBirth()%></p>
