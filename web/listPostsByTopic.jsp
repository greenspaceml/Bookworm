...
<html>
    <head>
        <%
            ...
            ArrayList<Poster> topicPosts = posterDAO.getPosterByTopicID(topic.getID());

            ArrayList<Topic> listTopics = topicDAO.getTopics();
            ...
            <aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        ...
                        %>
                        <li class="<%=(topic.getID().equals(t.getID())) ? "colorlib-active":"" %>"><a href="listPostsByTopic?tid=<%=t.getID()%>"><%=t.getText()%></a></li>
                            <%}%>
                    </ul>
                </nav>
                    ...
                    <div class="container">
                        <div class="row justify-content-center mb-5 pb-2">
                            <div class="col-md-7 heading-section text-center ftco-animate">
                                <h2 class="mb-4"><%=topic.getText()%></h2>
                                <p>List of my posts about book I have read !</p>
                                <%
                                    if (topicPosts.size() == 0) {
                                %>
                                <h3>We don't have any post about this Topic</h3>
                                <%}%>
                            </div>
                        </div>
                        <div class="row">
                            <%
                                for (Poster p : topicPosts) {
