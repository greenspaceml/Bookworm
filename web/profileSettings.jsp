        ...
        <div id="colorlib-page">
            ...
            <aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        <li class="colorlib-active"><a href="aboutMe?uid=<%=userInstance.getID()%>"> << Back To Profile</a></li>
                        ...
                        <div class="col-md-6 text ">
                            <div class="contact1">
                                <form action="profileSettings" method="post" >
                                    ...
                                    Name : <br>
                                    <div >
                                        <input type="text" name="name" value="<%=userInstance.getDisplayname()%>" required>
                                    </div><br>
                                    Date of Birth : <br>
                                    <div >
                                        <input  type="date" name="dob" value="<%=userInstance.getDateOfBirth()%>" required>
                                    </div><br>
                                    Gender : <br>
                                    <div >
                                        <input  type="text" name="hobbies" value="<%=userInstance.getHobbies()%>" required>
                                    </div><br>
                                    Email : <br>
                                    <div >
                                        <input  type="text" name="photoTitle" value="<%=Uphoto.getTittle()%>" required>
                                    </div><br>
                                    Address : <br>
                                    <div >
                                        <input  type="text" name="photoTitle" value="<%=Uphoto.getTittle()%>" required>
                                    ...
                                    Select you new photo : <br>
                                    <div >
                                        <input  type="file" name="photo" >
                                    </div><br><br>

                                    <div class="form-group">
                                        <input name="name" type="submit" value="Save change" class="btn btn-primary">
                                    </div>
                                </form>
                            </div>
                        </div>
