...
<html>
    <head>
        <%
            ...
            ArrayList<Poster> listPosterScriptSearched = posterDAO.searchByPosterScript(searchedText);;
                    ...
                    <div class="container">
                        <div class="row justify-content-center mb-5 pb-2">
                            <div class="col-md-7 heading-section text-center ftco-animate">
                                <h2 class="mb-4">  Posts have Script contains "<%=searchedText%>"  </h2>
                                <p>List of my posts about book I have read !</p>
                                <%
                                    if (listPosterScriptSearched.size() == 0) {
                                %>
                                <h3>We don't have any poster has Script contains "<%=searchedText%>"</h3>
                                <%}%>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <%
                                for (Poster p : listPosterScriptSearched) {
